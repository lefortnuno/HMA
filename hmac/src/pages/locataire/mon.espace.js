...
export default function MonEspace() {
  ...
  const declares = {};
  // Les déclarations d électricité vivent sur la page Facture JIRAMA.
  enAttente
    .filter((d) => (d.volet || "LOYER") === "LOYER")
  ...
  const totalPaye = paiements
    ...
    .reduce((s, p) => s + (p.montantLoyer || 0), 0);
